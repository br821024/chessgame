...
public class Center extends JFrame {
	...
	ArrayList<roomButton> roomlist = null; 
	...
	public void createroom(String account,String username,int side){
		roomlist.add(new roomButton(controller,account,username,side));
	}
	public void joinroom(String account,String username){
		for(int i=0;i<roomlist.size();i++){
			if(roomlist.get(i).account.equals(account)) roomlist.get(i).joinroom(username);
		}
	}
}
